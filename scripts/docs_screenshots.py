...
def main():
    ...
    with sync_playwright() as playwright:
        ...
        context.add_init_script(
            "localStorage.setItem('ccload_token','docs-sanitized-session');"
            "localStorage.setItem('ccload_token_expiry',String(Date.now()+3600000));"
