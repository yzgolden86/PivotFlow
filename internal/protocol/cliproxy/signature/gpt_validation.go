...
// MaxGPTReasoningSignatureLen caps opaque GPT reasoning signatures.
const MaxGPTReasoningSignatureLen = 32 * 1024 * 1024

// GPTReasoningSignatureInfo describes the decoded transport envelope.
type GPTReasoningSignatureInfo struct {
	DecodedLen    int
	CiphertextLen int
}

// IsValidGPTReasoningSignature reports whether a signature has a valid transport shape.
