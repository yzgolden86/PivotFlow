...
// GrokEncryptedContentInfo describes a validated opaque replay blob.
...
// IsValidGrokEncryptedContent reports whether encrypted content has a valid transport shape.
